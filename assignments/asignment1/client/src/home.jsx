            ...
            <div className="text-center text-xxl-start">
              <div className="badge bg-gradient-primary-to-secondary text-white mb-4">
                <div className="text-uppercase">
                  DESIGN · SOFTWARE DEVELOPMENT · TECHNOLOGY
                </div>
              </div>
          ...
          <div className="col-xxl-8">
            <div className="text-center my-5">
              ...
              <p className="lead fw-light mb-4">
                My name is Thomas, a passionate Software Developer.
              </p>
              <p className="text-muted">
              With expertise in JavaScript, Python, React, Node.js, I specialize in developing innovative solutions that solve complex problems and enhance user experiences. Let’s create something amazing together!
              </p>
              <div className="d-flex justify-content-center fs-2 gap-4">
                <a className="text-gradient" href="https://x.com/potus?lang=en">
                  <i className="bi bi-twitter" />
                </a>
                <a className="text-gradient" href="https://www.linkedin.com/company/donald-j-trump-for-president-2024-inc">
                  <i className="bi bi-linkedin" />
                </a>
                <a className="text-gradient" href="https://github.com/HumberEnjoyer">
